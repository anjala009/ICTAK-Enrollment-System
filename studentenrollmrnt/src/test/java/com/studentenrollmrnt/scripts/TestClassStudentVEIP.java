...
import com.studentenrollmrnt.pages.StudentLoginVEIP;
import com.studentenrollmrnt.testbase.TestBase;
import com.studentenrollmrnt.utilities.ExcelUtilities;

public class TestClassStudentVEIP extends TestBase{
	StudentLoginVEIP objLogin;
	@Test(priority=0)
    public void verifyValidLogin() throws IOException {
    
	//Create Login Page object
    objLogin = new StudentLoginVEIP(driver);
