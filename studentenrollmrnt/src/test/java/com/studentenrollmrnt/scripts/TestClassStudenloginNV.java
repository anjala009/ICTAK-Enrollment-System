...
import com.studentenrollmrnt.pages.StudentLoginNV;
import com.studentenrollmrnt.testbase.TestBase;
import com.studentenrollmrnt.utilities.ExcelUtilities;

public class TestClassStudenloginNV extends TestBase {
	StudentLoginNV objLogin; 
	@Test(priority=0)
    public void verifyValidLogin() throws IOException {
    //Create Login Page object
    objLogin = new StudentLoginNV(driver);
